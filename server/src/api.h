...
string post_message (unordered_map<string, Group>* groups, unordered_map<string, User>* users, string uid, string gid, string text_size, string text, string filename = "", string filesize  = "");
